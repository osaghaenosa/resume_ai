...
1.  **HTML ONLY:**  
    The entire output MUST be a single valid HTML string. Do NOT use markdown syntax such as \`\`\`html, and do NOT include any text outside of the main \`<div>\` container.
